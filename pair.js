            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'MDK-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of MDK-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vac8SosLYrrrrrFndv3Z) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [GHANO-LHENS  GitHub Repo](https://github.com/afk-bot-ui/)  

🚀 _Thanks for choosing MDK-MD — Let the automation begin!_ ✨`;
